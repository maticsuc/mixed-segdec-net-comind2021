...
class SegDecNet(nn.Module):
    def __init__(self, device, input_width, input_height, input_channels):
        ...
        self.seg_mask = nn.Sequential(Conv2d_init(in_channels=1024, out_channels=1, kernel_size=1, padding=0, bias=False), FeatureNorm(num_features=1, eps=0.001, include_bias=False))
