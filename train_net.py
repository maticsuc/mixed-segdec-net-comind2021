...
def parse_args():
    ...
    parser.add_argument('--SEG_BLACK', type=str2bool, default=False, required=False, help="Wheter to use segmentation blackening.")
    parser.add_argument('--THR_ADJUSTMENT', type=str2bool, default=False, required=False, help="Wheter to use threshold adjustment.")
